...
import 'package:trade/screen/uploadVidoes.dart';
                ...
                child: Wrap(
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(
                      ...
                      height: 160.0,
                      child:InkWell( 
                        onTap: (){  Navigator.push(context, MaterialPageRoute(builder: (context) => uploadVideos()));},
                        child: Card(
                        ...
                        child:Center(
                            child: Padding(
                              ...
                              child: Column(
                                children: <Widget>[
                                  Image.asset("assets/live-chat-icon-7413.png",width: 64.0,),
                                  SizedBox(
                                    height: 10.0,
                                  ),
                                  Text(
                      ...
                      child:InkWell( 
                        ...
                        child:Center(
                            child: Padding(
                              ...
                              child: Column(
                                children: <Widget>[
                                  Image.asset("assets/video-play-icon.png",width: 64.0,),
                                  SizedBox(
                                    height: 10.0,
                                  ),
                                  Text(
